...
import { Tooltip as Tooltip$1, Form, Input, Checkbox as Checkbox$1, Select as Select$1, InputNumber as InputNumber$2, DatePicker, Tabs } from 'antd';
import classNames from 'classnames';
import 'antd/es/form/style';
import 'antd/es/tabs/style';
import 'antd/es/input/style';
import 'antd/es/tooltip/style';
import { get as get$3 } from 'lodash-es';
...
function makeUpdaterByDependencies(dependencies, setReasonField) {
  return function (prevValues, currentValues) {
    ...
    return dependencies.some(function (dep) {
      ...
      var changed = get$3(prevValues, name) !== get$3(currentValues, name);
...
var StringInput = function StringInput(props) {
  ...
  return /*#__PURE__*/React.createElement(FormItemWrapper, {
...
var InputNumber = function InputNumber(props) {
  ...
  var _useState = useState(transformValue(value)),
      _useState2 = _slicedToArray(_useState, 2),
  ...
  return /*#__PURE__*/React.createElement(InputNumber$2, {
    style: {
      width: '100%'
    },
    size: "small",
...
var DatetimePicker = function DatetimePicker(props) {
  ...
  var _useState = useState(value ? hooks(value) : undefined),
      _useState2 = _slicedToArray(_useState, 2),
      innerValue = _useState2[0],
      setInnerValue = _useState2[1];
...
var SchemaForm = function SchemaForm(props) {
  ...
  return /*#__PURE__*/React.createElement(Form, Object.assign({
    ...
    form: form,
    layout: "vertical",
    className: classNames(css_248z$3.form, className)
  }, otherProps), /*#__PURE__*/React.createElement(Tabs, {
    type: "card",
    defaultActiveKey: (_schema$ = schema[0]) === null || _schema$ === void 0 ? void 0 : _schema$.name,
    className: classNames(css_248z$3.tabs, css_248z$3.controlNumberTab, (_classNames = {}, _defineProperty(_classNames, css_248z$3.singleTab, (schema === null || schema === void 0 ? void 0 : schema.length) === 1), _defineProperty(_classNames, css_248z$3.coupleTab, (schema === null || schema === void 0 ? void 0 : schema.length) === 2), _defineProperty(_classNames, css_248z$3.ternateTab, (schema === null || schema === void 0 ? void 0 : schema.length) === 3), _classNames))
...
export { ControlMap, ControlMapFactory, FormItemWrapper, SchemaForm, Tooltip, renderFormItemExtra };
