...
var ControlMapFactory = /*#__PURE__*/function () {
  function ControlMapFactory() {
    _classCallCheck(this, ControlMapFactory);

    this.controlMap = {};
  }

  _createClass(ControlMapFactory, [{
    key: "getComponent",
    value: function getComponent(shape) {
      return this.controlMap[shape];
    }
  }, {
    key: "setComponent",
    value: function setComponent(shape, component) {
      this.controlMap[shape] = component;
    }
  }]);

  return ControlMapFactory;
}();
var ControlMap = new ControlMapFactory();
...
var Tooltip = function Tooltip(props) {
  var text = props.text,
      otherProps = _objectWithoutProperties(props, ["text"]);

  if (!text) {
    return null;
  }

  return /*#__PURE__*/React__default['default'].createElement(antd.Tooltip, Object.assign({
    placement: "left",
    title: text
  }, otherProps), /*#__PURE__*/React__default['default'].createElement("div", {
    className: css_248z.tooltip
  }, text));
...
function makeUpdaterByDependencies(dependencies, setReasonField) {
  return function (prevValues, currentValues) {
    ...
    return dependencies.some(function (dep) {
      ...
      var changed = lodashEs.get(prevValues, name) !== lodashEs.get(currentValues, name);
...
var StringInput = function StringInput(props) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(FormItemWrapper, {
  ...
  return /*#__PURE__*/React__default['default'].createElement(FormItemWrapper, {
    ...
    return /*#__PURE__*/React__default['default'].createElement(antd.Form.Item, {
      ...
      getValueFromEvent: function getValueFromEvent(e) {
        ...
        return valueMap[type][checked.toString()];
      },
      getValueProps: function getValueProps(checked) {
        ...
        return {
          checked: !!checkedMap[checked.toString()]
        };
      }
...
var Select = function Select(props) {
  ...
  var required = controlSchema.required,
      ...
      label = controlSchema.label,
      placeholder = controlSchema.placeholder,
      _controlSchema$option = controlSchema.options,
      options = _controlSchema$option === void 0 ? [] : _controlSchema$option;
  return /*#__PURE__*/React__default['default'].createElement(FormItemWrapper, {
    schema: controlSchema
  }, function (_ref) {
    var hidden = _ref.hidden,
...
var InputNumber = function InputNumber(props) {
  ...
  var _useState = React.useState(transformValue(value)),
      _useState2 = _slicedToArray(_useState, 2),
  ...
  var onValueChange = React.useCallback(function (nextValue) {
...
var InputNumber$1 = function InputNumber$1(props) {
  var controlSchema = props.controlSchema;
  var required = controlSchema.required,
      tooltip = controlSchema.tooltip,
      extra = controlSchema.extra,
...
var DatetimePicker = function DatetimePicker(props) {
  ...
  var _useState = React.useState(value ? hooks(value) : undefined),
      _useState2 = _slicedToArray(_useState, 2),
      innerValue = _useState2[0],
      setInnerValue = _useState2[1];
  ...
  React.useEffect(function () {
    ...
    var valueMoment = hooks(value);

    if (valueMoment.isValid()) {
      setInnerValue(valueMoment);
    }
  }, [value]);
  var onChangeMoment = React.useCallback(function (_, dateString) {
    var nextMoment = hooks(dateString);
...
var Datetime = function Datetime(props) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(FormItemWrapper, {
    ...
    return /*#__PURE__*/React__default['default'].createElement(antd.Form.Item, {
      ...
      required: required,
      hidden: hidden
    }, /*#__PURE__*/React__default['default'].createElement(DatetimePicker, {
      style: {
        width: '100%'
      },
      disabled: disabled
...
ControlMap.setComponent('Input', StringInput);
ControlMap.setComponent('Checkbox', Checkbox);
ControlMap.setComponent('Select', Select);
ControlMap.setComponent('InputNumber', InputNumber$1);
ControlMap.setComponent('Password', Password);
ControlMap.setComponent('Datetime', Datetime);
ControlMap.setComponent('Textarea', TextArea);

var css_248z$3 = "/* stylelint-disable at-rule-empty-line-before,at-rule-name-space-after,at-rule-no-unknown */\n/* stylelint-disable no-duplicate-selectors */\n/* stylelint-disable */\n/* stylelint-disable declaration-bang-space-before,no-duplicate-selectors,string-no-newline */\n.form :global label {\n  font-size: 12px;\n}\n.form :global .ant-form-item {\n  margin-bottom: 12px;\n}\n.form :global .ant-form-item .ant-form-item-label {\n  padding-bottom: 4px;\n}\n.form :global .ant-form-item .ant-form-item-label > label {\n  color: #666;\n}\n.form :global .ant-form-item .ant-form-item-control .ant-checkbox-wrapper {\n  color: #666;\n}\n.form :global .ant-form-item-explain,\n.form :global .ant-form-item-extra {\n  font-size: 12px;\n}\n.form :global .ant-form-item-extra {\n  margin-top: 4px;\n}\n.form .tabs {\n  height: 100%;\n  flex-direction: column;\n}\n.form .tabs :global .ant-tabs-nav {\n  box-shadow: 0 0 16px -5px rgba(0, 0, 0, 0.2);\n}\n.form .tabs :global .ant-tabs-nav .ant-tabs-nav-list {\n  width: 100%;\n}\n.form .tabs :global .ant-tabs-nav .ant-tabs-nav-list .ant-tabs-tab {\n  font-size: 12px;\n}\n.form .tabs :global .ant-tabs-nav .ant-tabs-nav-list .ant-tabs-tab-active {\n  border-bottom-width: 0;\n}\n.form .tabs :global .ant-tabs-nav .ant-tabs-nav-list .ant-tabs-tab-active .ant-tabs-tab-btn {\n  color: #1890ff;\n}\n.form .tabs :global .ant-tabs-nav .ant-tabs-nav-list .ant-tabs-tab .ant-tabs-tab-btn {\n  text-align: center;\n  font-weight: normal;\n}\n.form .tabs :global .ant-tabs-content-holder {\n  padding: 0 16px;\n  overflow-y: auto;\n}\n.form .tabs.controlNumberTab :global .ant-tabs-nav .ant-tabs-nav-list {\n  background-color: #f7f9fb;\n}\n.form .tabs.controlNumberTab :global .ant-tabs-nav .ant-tabs-nav-list .ant-tabs-tab {\n  background-color: #f7f9fb;\n}\n.form .tabs.controlNumberTab :global .ant-tabs-nav .ant-tabs-nav-list .ant-tabs-tab .ant-tabs-tab-btn {\n  width: 100%;\n}\n.form .tabs.singleTab :global .ant-tabs-tab {\n  width: 100%;\n}\n.form .tabs.coupleTab :global .ant-tabs-tab {\n  width: 50%;\n  margin-right: 0;\n  border-right-width: 0;\n}\n.form .tabs.coupleTab :global .ant-tabs-tab:last-of-type {\n  border-right-width: 1px;\n}\n.form .tabs.ternateTab :global .ant-tabs-tab {\n  width: 33%;\n  margin-right: 0;\n  border-right-width: 0;\n}\n.form .tabs.ternateTab :global .ant-tabs-tab:last-of-type {\n  border-right-width: 1px;\n}\n";
styleInject(css_248z$3);

var TabPane = antd.Tabs.TabPane;
var SchemaForm = function SchemaForm(props) {
  var _schema$, _classNames;

  var schema = props.schema,
      formInstance = props.form,
      className = props.className,
      otherProps = _objectWithoutProperties(props, ["schema", "form", "className"]);

  var _Form$useForm = antd.Form.useForm(formInstance),
  ...
  return /*#__PURE__*/React__default['default'].createElement(antd.Form, Object.assign({
    ...
    form: form,
    layout: "vertical",
    className: classNames__default['default'](css_248z$3.form, className)
  }, otherProps), /*#__PURE__*/React__default['default'].createElement(antd.Tabs, {
    type: "card",
    defaultActiveKey: (_schema$ = schema[0]) === null || _schema$ === void 0 ? void 0 : _schema$.name,
    className: classNames__default['default'](css_248z$3.tabs, css_248z$3.controlNumberTab, (_classNames = {}, _defineProperty(_classNames, css_248z$3.singleTab, (schema === null || schema === void 0 ? void 0 : schema.length) === 1), _defineProperty(_classNames, css_248z$3.coupleTab, (schema === null || schema === void 0 ? void 0 : schema.length) === 2), _defineProperty(_classNames, css_248z$3.ternateTab, (schema === null || schema === void 0 ? void 0 : schema.length) === 3), _classNames))
  }, schema.map(function (tab) {
    ...
    return /*#__PURE__*/React__default['default'].createElement(TabPane, {
      ...
      var ControlComponent = ControlMap.getComponent(shape);
      ...
      return /*#__PURE__*/React__default['default'].createElement(ControlComponent, {
        key: controlName,
...
exports.ControlMapFactory = ControlMapFactory;
