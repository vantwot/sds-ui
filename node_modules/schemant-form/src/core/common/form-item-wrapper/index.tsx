...
import { ControlSchema, UpdateReasonField } from '../../index';
import {
  makeUpdaterByDependencies,
  makeFormItemControlledProps,
  isEmptyParamValue,
} from './util';
...
export const FormItemWrapper: React.FC<Props> = props => {
  ...
  if (typeof children !== 'function') {
    throw new Error(
      '[Schema Form]: chilren of FormItemWrapper should be a render prop.',
    );
  }
