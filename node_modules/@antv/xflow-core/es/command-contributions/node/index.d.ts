...
/** 扩展 Command Hooks 类型*/
export interface ICmdHooks extends NsAddNode.ICmdHooks, NsDelNode.ICmdHooks, NsSelectNode.ICmdHooks, NsMoveNode.ICmdHooks, NsUpdateNode.ICmdHooks, NsCenterNode.ICmdHooks, NsFrontNode.ICmdHooks, NsBackNode.ICmdHooks, NsHighlightNode.ICmdHooks, IHooks {
}
/** Command 参数类型*/
