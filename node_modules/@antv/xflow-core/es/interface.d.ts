...
export declare namespace NsGraph {
    ...
    type INodeRender<T extends NsGraph.INodeConfig = any> = React.FC<IReactNodeProps<T>>;
    /** XFlow Edge Props */
    interface IReactEdgeProps<T = any> {
        data: T;
    }
    /** XFlow Edge label 组件类型 */
    type IEdgeRender<T extends NsGraph.IEdgeConfig = any> = React.FC<IReactEdgeProps<T>>;
    /** xflow 封装的 X6 event */
