            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, hooks.updateEdge.call(args, function (handlerArgs) { return __awaiter(_this, void 0, void 0, function () {
                                var x6Graph, updateEdgeService, edgeConfig, _a, x6Edge;
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0: return [4 /*yield*/, this.ctx.getX6Graph()];
                                        case 1:
                                            x6Graph = _b.sent();
                                            updateEdgeService = handlerArgs.updateEdgeService;
                                        ...
                                        case 2:
                                            ...
                                            return [3 /*break*/, 4];
                                        case 3:
                                            _a = handlerArgs === null || handlerArgs === void 0 ? void 0 : handlerArgs.edgeConfig;
                                            _b.label = 4;
                                        case 4:
                                            edgeConfig = _a;
