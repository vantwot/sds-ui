...
var AddNodeCommand = /** @class */ (function () {
    ...
    function AddNodeCommand() {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        hooks = ctx.getHooks();
                        return [4 /*yield*/, hooks.addNode.call(args, function (handlerArgs) { return __awaiter(_this, void 0, void 0, function () {
                                var createNodeService, cellFactory, commandService, graph, node, _a, nodeConfig, x6NodeCell, cell;
                                var _this = this;
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0:
                                        ...
                                        case 2:
                                            ...
                                            return [3 /*break*/, 4];
                                        case 3:
                                            _a = handlerArgs.nodeConfig;
                                            _b.label = 4;
                                        case 4:
                                            node = _a;
                                            return [4 /*yield*/, this.processNodeConfig(node)];
                                        case 5:
                                            nodeConfig = _b.sent();
                                            if (!cellFactory) return [3 /*break*/, 7];
                                        ...
                                        case 8:
                                            ...
                                            ctx.addUndo(disposable_1.Disposable.create(function () { return __awaiter(_this, void 0, void 0, function () {
                                                ...
                                                return __generator(this, function (_a) {
                                                    nodeData = __assign({ id: x6NodeCell.id }, x6NodeCell.getData());
        ...
        this.processNodeConfig = function (nodeConfig) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                         ...
                         */
                        nodeConfig.data = __assign({}, nodeConfig);
                        /** 非 react shape */
                        if (nodeConfig.shape) {
        ...
        this.getNodeReactComponent = function (nodeConfig) { return __awaiter(_this, void 0, void 0, function () {
