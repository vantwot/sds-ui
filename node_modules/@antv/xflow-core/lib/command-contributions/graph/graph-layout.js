            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, hooks.graphLayout.call(args, function (handlerArgs) { return __awaiter(_this, void 0, void 0, function () {
                                    ...
                                    switch (_a.label) {
                                        case 0:
                                            ...
                                            innerLayout = function (graphData) {
                                                var AntVLayout = layout_1.Registy.getLayoutByName(layoutType);
                                                var antVLayout = new AntVLayout(layoutOptions);
