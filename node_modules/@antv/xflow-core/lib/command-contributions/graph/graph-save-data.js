                                    ...
                                    switch (_a.label) {
                                        ...
                                        case 1:
                                            ...
                                            nodes = x6Nodes.map(function (node) {
                                                ...
                                                var size = node.size();
                                                var model = __assign(__assign(__assign({ id: node.id }, data), position), size);
                                                if (includeAttrs) {
                                            ...
                                            edges = x6Edges.map(function (edge) {
                                                ...
                                                var model = __assign({ id: edge.id }, data);
                                                if (includeAttrs) {
                                            ...
                                            return [4 /*yield*/, model_service_1.MODELS.GRAPH_META.useValue(ctx.getModelService())
                                                /** 执行 service */
                                            ];
                                        case 2:
                                            graphMeta = _a.sent();
