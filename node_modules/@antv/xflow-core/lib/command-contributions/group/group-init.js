            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        hooks = ctx.getHooks();
                        return [4 /*yield*/, hooks.initGroup.call(args, function (handlerArgs) { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 1:
                                            ...
                                            Object.keys(groupMap).forEach(function (groupId) { return __awaiter(_this, void 0, void 0, function () {
                                                ...
                                                return __generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        case 0:
                                                            ...
                                                            groupNode.setData(__assign(__assign({}, groupData), { isGroup: true, groupChildren: childrenIds }));
