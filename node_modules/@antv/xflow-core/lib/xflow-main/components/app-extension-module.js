...
function XFlowAppExtensionMoudle(props) {
    ...
    /** Config */
    var config = react_1.default.useMemo(function () { return props.config || { CONFIG_TYPE: '', getConfig: function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
            return [2 /*return*/, ({})];
        }); }); } }; }, 
