...
var movedNode = function (e, cmds) { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    ...
                                    if (!(currentNode && position)) return [3 /*break*/, 2];
                                    return [4 /*yield*/, cmds.executeCommand(xflow_core_1.XFlowNodeCommands.UPDATE_NODE.id, {
                                            nodeConfig: __assign(__assign(__assign({}, currentNode.data), position), currentNode.getSize()),
                                        })];
                                case 1:
                                    _b.sent();
                                    _b.label = 2;
...
/** 修改节点大小 */
var resizeNode = function (e, cmds) { return __awaiter(void 0, void 0, void 0, function () {
    var node, nodeConfig;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
/** 添加辅助工具 */
var addTools = function (e) { return __awaiter(void 0, void 0, void 0, function () {
    var edge;
    return __generator(this, function (_a) {
        edge = e.edge;
        if (!edge) {
...
/** 移除辅助工具 */
var removeTools = function (e, cmds) { return __awaiter(void 0, void 0, void 0, function () {
    var edge;
    return __generator(this, function (_a) {
        edge = e.edge;
        if (!edge) {
