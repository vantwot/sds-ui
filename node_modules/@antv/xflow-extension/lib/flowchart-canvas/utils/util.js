...
var setInstance = function (app) { return __awaiter(void 0, void 0, void 0, function () {
    var x6graph;
...
var getGraphData = function () { return __awaiter(void 0, void 0, void 0, function () {
    var app, data;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                app = (0, exports.getAppInstance)();
                return [4 /*yield*/, app.executeCommand(xflow_core_1.XFlowGraphCommands.SAVE_GRAPH_DATA.id, {
...
exports.onConfigChange = (0, lodash_1.debounce)(function (config) {
    ...
    return configChange(__assign({ data: (0, exports.getGraphData)() }, config));
}, 300, {
    trailing: true,
});
