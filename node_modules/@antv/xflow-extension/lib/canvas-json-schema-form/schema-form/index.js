...
var SchemaForm = function (props) {
    ...
    return (react_1.default.createElement(antd_1.Form, __assign({ size: "small", form: form, layout: "vertical", className: (0, classnames_1.default)('xflow-json-form', className) }, otherProps),
