...
var PanelBody = function (props) {
    ...
    var controlMapCache = react_1.default.useMemo(function () {
        var controlMap = (0, index_1.makeControlMap)(__spreadArray(__spreadArray([], index_1.xflowDefaultControls, true), defaultControls, true));
    ...
    if (loading) {
        return (react_1.default.createElement("div", { className: props.prefixClz + "-body", style: __assign(__assign({}, props.style), { display: 'flex', justifyContent: 'center', alignItems: 'center' }) },
            react_1.default.createElement(antd_1.Spin, { spinning: true })));
    }
    return (react_1.default.createElement("div", { className: props.prefixClz + "-body", style: props.style },
