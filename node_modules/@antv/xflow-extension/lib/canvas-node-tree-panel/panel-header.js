...
var NodePanelHeader = function (props) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("div", { className: prefixClz + "-header", style: props.style },
            panelProps.header && react_1.default.isValidElement(panelProps.header) && panelProps.header,
            panelProps.searchService && (react_1.default.createElement("div", { className: prefixClz + "-header-search" },
