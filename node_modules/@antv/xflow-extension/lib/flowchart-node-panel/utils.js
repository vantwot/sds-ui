...
var NodesComponent = __importStar(require("./nodes"));
...
var nodeService = function (nodes) { return __awaiter(void 0, void 0, void 0, function () {
    var customNodes;
...
var createPath = function (paths, offsetX, offsetY) {
    ...
    paths.forEach(function (item) {
        ...
        path += (0, lodash_1.isNumber)(y) ? " " + c + " " + (x + offsetX) + " " + (y + offsetY) : " " + c;
        if (c2y) {
