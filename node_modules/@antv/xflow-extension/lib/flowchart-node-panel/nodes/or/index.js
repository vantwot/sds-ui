...
var OrNode = function (props) {
    ...
    return (react_1.default.createElement("svg", { viewBox: "0 0 " + width + " " + height, xmlns: "http://www.w3.org/2000/svg", width: "100%", height: "100%" },
        react_1.default.createElement("path", { d: "M " + constants_1.NODE_PADDING + "," + height / 2 + " a " + availableR / 2 + " " + availableR / 2 + " 0 1 1 0 1 z", fill: fill, stroke: stroke }),
