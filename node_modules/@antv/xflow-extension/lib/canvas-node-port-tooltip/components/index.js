...
var CanvasNodePortTooltip = function (props) {
    var getConfig = react_1.default.useCallback(function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
    ...
    return (react_1.default.createElement(xflow_core_1.XFlowAppExtensionMoudle, { createModule: module_1.createModule, config: { CONFIG_TYPE: exports.CONFIG_TYPE, getConfig: getConfig } },
        react_1.default.createElement(RenderTooltip, __assign({}, props))));
};
