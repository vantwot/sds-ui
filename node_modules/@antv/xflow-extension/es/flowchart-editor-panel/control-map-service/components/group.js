...
const GroupComponent = props => {
    ...
    return (React.createElement("div", { className: `${PREFIX}-panel-body` },
        React.createElement("div", { className: `${PREFIX}-panel-group` },
            ...
            React.createElement(InputFiled, { label: "\u6807\u9898", value: groupConfig.label, onChange: value => {
        ...
        React.createElement("div", { className: `${PREFIX}-panel-group` },
            ...
            React.createElement(ColorPicker, { label: "\u586B\u5145", value: groupConfig.fill, onChange: (value) => {
                    onGroupConfigChange('fill', value);
                } }),
            React.createElement(ColorPicker, { label: "\u8FB9\u6846", value: groupConfig.stroke, onChange: (value) => {
                    onGroupConfigChange('stroke', value);
                } }),
            React.createElement("div", { className: `${PREFIX}-node-text-style` },
                React.createElement(InputNumberFiled, { label: "\u5B57\u53F7", value: groupConfig.fontSize, width: 68, onChange: value => {
