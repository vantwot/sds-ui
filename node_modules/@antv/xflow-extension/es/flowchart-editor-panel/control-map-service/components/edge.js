...
const EdgeComponent = props => {
    ...
    return (React.createElement("div", { className: `${PREFIX}-panel-body` },
        React.createElement("div", { className: `${PREFIX}-panel-group` },
            ...
            React.createElement(InputFiled, { label: "\u6807\u7B7E", value: edgeConfig.label, onChange: value => {
        ...
        React.createElement("div", { className: `${PREFIX}-panel-group`, style: { marginBottom: 0 } },
            ...
            React.createElement(SelectField, { label: "\u7BAD\u5934", value: getArrowValue(), width: "100%", options: [
                    {
                        label: '正向',
                        value: 'target',
                    },
            ...
            React.createElement(ColorPicker, { label: "\u8FB9\u6846", value: getAttrs('stroke'), onChange: (value) => {
        ...
        React.createElement("div", { className: `${PREFIX}-panel-group` },
            ...
            React.createElement("div", { className: `${PREFIX}-edge-text-style` },
                React.createElement(InputNumberFiled, { label: "\u5B57\u53F7", min: 10, width: 68, value: getAttrs('fontSize', 'text') || 12, onChange: value => {
