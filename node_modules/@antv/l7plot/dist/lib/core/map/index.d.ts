...
import { MapOptions, AMapInstance, MapboxInstance, ZoomControlOptions, LayerMenuControlOptions, ScaleControlOptions, LegendOptions, IPLotLayer, UpdateMapConfig, Bounds } from '../../types';
...
export declare abstract class Map<O extends MapOptions> extends EventEmitter {
     ...
     * 移除图层
     */
    removeLayer(layer: IPLotLayer): void;
    /**
     * 移除容器内所有的图层
     */
    removeAllLayer(): void;
